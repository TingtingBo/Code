...
seed_dir = {'MAC_DE_08' 'MAC_DE_09' 'MAC_DE_011' 'MAC_DE_013' 'MAC_DE_016' 'MAC_DE_018' 'MAC_DE_024' 'MAC_DE_025' 'MAC_CON_08' 'MAC_CON_09' 'MAC_CON_011' 'MAC_CON_013' 'MAC_CON_016' 'MAC_CON_018' 'MAC_CON_024' 'MAC_CON_025'};
%roi_names = seed_rois; 
denoised_vol = {'Denoised_rest.nii'}; % Resting/Residual volumes
names = {'rest_in_taskb'}; % name to append as suffix to output files
...
subjects = {'MAC_DE_08' 'MAC_DE_09' 'MAC_DE_011' 'MAC_DE_013' 'MAC_DE_016' 'MAC_DE_018' 'MAC_DE_024' 'MAC_DE_025'  'MAC_CON_08' 'MAC_CON_09' 'MAC_CON_011' 'MAC_CON_013' 'MAC_CON_016' 'MAC_CON_018'  'MAC_CON_024' 'MAC_CON_025' };
% took out 26 for task becuase there isnt one took out 19 becuse denoised
% task is 0 kb
...
for i = 1:length(subjects);
    ...
    for j = 1:length(denoised_vol)
        ...
        util_voxelwise_fc_auto_tempwbtask(cfg);
