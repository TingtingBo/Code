...
path_correl_con = '/media/store3/Projects/Wess/subjects/Whole_Brain_MD/ZCorrel_con'; % Path to load correlation images
path_correl_con2 = '/media/store3/Projects/Wess/subjects/Whole_Brain_MD/ZCorrel_con'; % path to load correlation images
path_correl = '/media/store3/Projects/Wess/subjects/Whole_Brain_MD/ZCorrel_con/Difference_Images_CON';
...
%subjects = {'MAC_DE_08' 'MAC_DE_09' 'MAC_DE_011' 'MAC_DE_013' 'MAC_DE_016' 'MAC_DE_018' 'MAC_DE_019' 'MAC_DE_024' 'MAC_DE_025' 'MAC_DE_026'};
n_rois = 1;
suffix = {'.2_LH_V1.label_roi' '.5_LH_V1.label_roi'};
names = {'difftest'};
...
for j= 1:n_rois
    ...
    for i=1:length(subjects)
        ...
        myfile = strcat('ZCorrel_',subjects{i}, '_','test_r',subjects{i}, suffix{1}, '.img');
        temp = load_nii(myfile);
        lanes_img_1 = temp.img;
        cd(fullfile(path_correl_con2));
        myfile2 = strcat('ZCorrel_',subjects{i}, '_','test_r',subjects{i}, suffix{2}, '.img');
        ...
        cd(path_correl);
        save_nii(temp, strcat(subjects{i}, '_difference_', names{j}));
