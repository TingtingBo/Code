...
path_correl_con = '/media/store3/Projects/Wess/subjects/Whole_Brain_MD/ZCorrel_con/Difference_Images_CON'; % Path to load correlation images
path_correl_con2 = '/media/store3/Projects/Wess/subjects/Whole_Brain_MD/ZCorrel_con/Difference_Images_CON'; % path to load correlation images
...
for j= 1:n_rois
    ...
    for i=1:length(subjects)
        ...
        myfile = strcat(subjects{i},'_difference_difftest', '.img');
        temp = load_nii(myfile);
        lanes_img_1 = temp.img;
        cd(fullfile(path_correl_con2));
        myfile2 = strcat(subjects{i}, '_difference_task_difftest', '.img');
        ...
        cd(path_correl);
        save_nii(temp, strcat(subjects{i}, '_difference_restminustask_', names{j}));
