...
%cd(path_subj);
%subjects = dir('EEG*');
subjects = {'MAC_CON_08_t' 'MAC_CON_09_t' 'MAC_CON_011_' 'MAC_CON_013_' 'MAC_CON_016_' 'MAC_CON_018_' 'MAC_CON_024_' 'MAC_CON_025_' 'MAC_CON_019' 'MAC_CON_026'}; 
%subjects = {'MAC_DE_08_ta' 'MAC_DE_09_ta' 'MAC_DE_011_t' 'MAC_DE_013_t' 'MAC_DE_016_t' 'MAC_DE_018_t' 'MAC_DE_024_t' 'MAC_DE_025_t' };
n_rois = 1;
suffix = {'mean_roi2_task' 'mean_roi5_task'};
names = {'task'};
...
for j= 1:n_rois
    ...
    for i=1:length(subjects)
        ...
        cd(path_correl);
        save_nii(temp, strcat(subjects{i}, 'CminP', names{j}));
